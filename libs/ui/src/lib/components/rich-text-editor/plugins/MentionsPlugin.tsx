...
function useMentionLookupService(mentionString: any) {
...
function checkForAtSignMentions(text: any, minMatchLength: any): MentionMatch | null {
...
function getPossibleMentionMatch(text: any): MentionMatch | null {
...
function tryToPositionRange(match: MentionMatch, range: Range): boolean {
  ...
  const anchorNode = domSelection.anchorNode as any;
